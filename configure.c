...
#define GDB_10_2   (6)
#define GDB_15_2   (7)
#define SUPPORTED_GDB_VERSIONS (GDB_15_2 + 1)

int default_gdb = GDB_15_2;
...
struct supported_gdb_version {
	...
	},
	{
        ...
        },
        {
            "GDB=gdb-15.2",
            "15.2",
            "GDB_FILES=${GDB_15.2_FILES}",
            "GDB_OFILES=${GDB_15.2_OFILES}",
            "GDB_PATCH_FILES=gdb-15.2.patch",
            "GDB_FLAGS=-DGDB_15_2",
            "GPLv3"
        },
};
	 ...
	 */
		...
		if (strcmp(buf, "7.6") == 0) {
			...
			return store_gdb_defaults(sp);
                ...
                if (strcmp(buf, "15.2") == 0) {
                        fclose(fp);
                        sp = &supported_gdb_versions[GDB_15_2];
                        fprintf(stderr, ".gdb configuration: %s\n", sp->GDB_VERSION_IN);
                        return store_gdb_defaults(sp);
                }
        }
